...
function insertFormatting(tag) {
    ...
    let insertText = '';
    switch(tag) {
        case 'b': insertText = `[b]${selectedText}[/b]`; break;
        case 'i': insertText = `[i]${selectedText}[/i]`; break;
        case 'u': insertText = `[u]${selectedText}[/u]`; break;
        case 's': insertText = `[s]${selectedText}[/s]`; break;
        case 'code': insertText = `[code]${selectedText}[/code]`; break;
        case 'url': const url = selectedText.length > 0 ? selectedText : 'https://'; insertText = `[url=${url}]Lien[/url]`; break;
        case 'img': insertText = `[img]${selectedText}[/img]`; break;
