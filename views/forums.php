            ...
            <div class="forums-container">
                ...
                <div class="forum-controls" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
                    ...
                    <div class="forum-actions">
                        ...
                        <?php else: ?>
                            <a href="index.php?route=login" class="btn btn-outline">Connectez-vous pour participer</a>
                        <?php endif; ?>
                    </div>
                </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content" style="text-align: center;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                <a href="index.php?route=login" class="btn btn-primary" style="width: 100%;">Connexion</a>
                                <a href="index.php?route=register" class="btn btn-outline" style="width: 100%;">Inscription</a>
                            </div>
                        </div>
                    </div>
                <?php else: ?>
