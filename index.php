...
$allowed_routes = ['home','article','articles','forums','contact','login','register','new-article','new-thread','about','charte','terms','privacy','dev','cyber-securite','members','admin','chronicles'];
...
switch ($route) {
    ...
    case 'members':
        ...
        break;
    case 'chronicles':
        require_once __DIR__ . '/controllers/ChroniclesController.php';
        $controller = new ChroniclesController($api);
        $controller->index();
        break;
    case 'admin':
